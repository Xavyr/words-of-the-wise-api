...
module.exports = {
  ...
  Titan: {
    ...
    paradigms: async (parent, args, {
      dataSources
    }) => {
      const titanName = parent.name;
      const collections = await dbCollections;
      return new Promise((resolve, reject) => {
        return collections.paradigms.find({
          titan: titanName
        }).toArray(function (err, results) {
          resolve(results);
        });
    ...
    inspirationals: async (parent, args, {
      dataSources
    }) => {
      const titanName = parent.name;
      const collections = await dbCollections;
      return new Promise((resolve, reject) => {
        return collections.inspirationals.find({
          titan: titanName
        }).toArray(function (err, results) {
          resolve(results);
        });
    ...
    routines: async (parent, args, {
      dataSources
    }) => {
      const titanName = parent.name;
      const collections = await dbCollections;
      return new Promise((resolve, reject) => {
        return collections.routines.find({
          titan: titanName
        }).toArray(function (err, results) {
          resolve(results);
        });
  ...
  Mutation: {
    saveTitan: async (parent, args, {
      ...
      const insertedParadigmIdsPromise = saveParadigms(paradigms, paradigmCollection);
      const insertedInspirationalIdsPromise = saveInpirationals(inspirationals, inspirationalCollection);
      const insertedRoutineIdsPromise = saveRoutines(routines, routineCollection);
      Promise.all([insertedQuoteIdsPromise, insertedPracticeIdsPromise, insertedParadigmIdsPromise, insertedInspirationalIdsPromise, insertedRoutineIdsPromise]).then(values => {
        return new Promise((resolve, reject) => {
    ...
    deleteAllParadigms: async (parent, args, {
      dataSources
    }) => {
      const collections = await dbCollections;
      return new Promise((resolve, reject) => {
    ...
    deleteAllInspirationals: async (parent, args, {
      dataSources
    }) => {
      const collections = await dbCollections;
      return new Promise((resolve, reject) => {
...
const saveParadigms = (paradigmDocuments, paradigmCollection) => {
  ...
  return new Promise((resolve, reject) => {
    ...
    paradigmCollection.insertMany(paradigmDocuments, function (err, paradigmsInserted) {
...
const saveInpirationals = (inspirationalDocuments, inspirationalCollection) => {
  ...
  return new Promise((resolve, reject) => {
    ...
    inspirationalCollection.insertMany(inspirationalDocuments, function (err, inspirationalsInserted) {
...
const saveRoutines = (routineDocuments, routineCollection) => {
  ...
  return new Promise((resolve, reject) => {
    console.log("Inspirationals", routineDocuments);
    routineCollection.insertMany(routineDocuments, function (err, routinesInserted) {
